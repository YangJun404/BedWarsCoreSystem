# execute if entity @p[nbt={Inventory:[{Slot:-106b,id:"minecraft:red_wool"}]}] run data modify entity @e[type=marker,limit=1,sort=nearest,tag=map,tag=map_importer] data.map.team.red.spawn set from entity @s Pos
...
# execute if entity @p[nbt={Inventory:[{Slot:-106b,id:"minecraft:green_wool"}]}] run data modify entity @e[type=marker,limit=1,sort=nearest,tag=map,tag=map_importer] data.map.team.green.spawn set from entity @s Pos
...
# execute if entity @p[nbt={Inventory:[{Slot:-106b,id:"minecraft:yellow_wool"}]}] run data modify entity @e[type=marker,limit=1,sort=nearest,tag=map,tag=map_importer] data.map.team.yellow.spawn set from entity @s Pos
...
# execute if entity @p[nbt={Inventory:[{Slot:-106b,id:"minecraft:blue_wool"}]}] run data modify entity @e[type=marker,limit=1,sort=nearest,tag=map,tag=map_importer] data.map.team.blue.spawn set from entity @s Pos
...
# 保存数据到实体
execute if entity @s[tag=blue_team] run data modify entity @e[limit=1,tag=map_importer,type=marker,tag=map] data.map.team.blue.spawn set from entity @s Pos
...
execute if entity @s[tag=red_team] run data modify entity @e[limit=1,tag=map_importer,type=marker,tag=map] data.map.team.red.spawn set from entity @s Pos
...
execute if entity @s[tag=green_team] run data modify entity @e[limit=1,tag=map_importer,type=marker,tag=map] data.map.team.green.spawn set from entity @s Pos
...
execute if entity @s[tag=yellow_team] run data modify entity @e[limit=1,tag=map_importer,type=marker,tag=map] data.map.team.yellow.spawn set from entity @s Pos
