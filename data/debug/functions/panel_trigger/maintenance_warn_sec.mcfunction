...
# 发送参数传递内容
execute if score $maintenance_transfer temp matches 0.. run function debug:panel_trigger/maintenance_warn_third with storage bw:basic temp.maintenance

# loop
execute if score $maintenance_transfer temp matches 1.. run function debug:panel_trigger/maintenance_warn_sec